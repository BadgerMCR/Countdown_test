...
export default {
	...
	computed: {
		...
		cssVars() {
		  ...
		  solidColorStyle() {  								//HERE IS THE CODE TO EXCHANGE THE PROPS FROM INDEX TO COMPONENT
			return {
				colorA: this.widget.props.colorA,
				colorB: this.widget.props.colorB,
			}
		}
	...
	methods: {
		...
		set_Number_of_cards: function() {
			if (this.widget.props.number_of_cards !== "") {
				this.number_of_cards = this.widget.props.number_of_cards
			}
			setTimeout(this.setScore, 500)
		},
